...
public class EmptyActivity extends Activity {
    ...
    private static KsRewardVideoAd mRewardedVideoAd;
    ...
    public static void showRewardVideoAd(KsRewardVideoAd rewardedVideoAd) {
...
//        Toast.makeText(this, "EmptyActivity起来了", Toast.LENGTH_SHORT).show();
        ...
        if (showType == SHOW_REWARD_VIDEO && mRewardedVideoAd != null) {
            mRewardedVideoAd.showRewardVideoAd(this, null);
