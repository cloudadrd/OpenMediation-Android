...
import com.nbmediation.sdk.mobileads.plugin4.BuildConfig;
import com.nbmediation.sdk.mobileads.plugin4.EmptyActivity;
...
public class TikTokAdapter extends CustomAdsAdapter {
    ...
    private static class InnerRvAdShowListener implements TTRewardVideoAd.RewardAdInteractionListener {
        ...
        @Override
        public void onRewardVerify(boolean rewardVerify, int rewardAmount, String s, int i1, String rewardName) {
